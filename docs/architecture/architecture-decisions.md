...
| AD-6 | GitHub Actions + Docker Compose definieren einheitliche Laufzeit für Backend & DB. | Treiber: Deployment-Parität, schnelles Onboarding (Supportability 3.5). | Taktiken: Automatisierung, Environment Parity; Muster: Infrastructure-as-Code (`docker-compose.yml`, `.github/workflows/*`). | umgesetzt |
