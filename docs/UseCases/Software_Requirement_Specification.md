...
## 1. Einleitung
### 1.1 Zweck
Dieses Software Requirements Specification (SRS) beschreibt die funktionalen und nicht-funktionalen Anforderungen an **BetCeption**, eine Webanwendung, die ein virtuelles Casino-Erlebnis mit Fokus auf **Homepage** und **Sidebets** (Zusatzwetten auf Ereignisse innerhalb einer Runde) bietet.  
...
Zusätzliche Casinospiele neben Homepage sowie Administrationsfunktionen (Moderation/Benutzerverwaltung) sind nicht Teil des MVP.
...
| Sidebet | Zusatzwette auf ein Ereignis innerhalb einer Homepage-Runde, zum Beispiel „Dealer gewinnt“. |
...
| Dealer | Bank im Homepage. Spielt nach festen Regeln und nicht frei wie der Spieler. |
...
| Homepage (Natural) | Start mit Ass und einer Zehn-Wert-Karte (10/J/Q/K). Zählt als 21 bei der ersten Ausgabe. |
...
**3.1.2 Spiel starten**  
Der Spieler setzt seinen Haupteinsatz und startet eine neue Homepage-Runde. Der Dealer gibt aus und die Runde beginnt.  
...
#### 3.5.2 Teststrategie
Unit-Tests für Homepage-Logik, Sidebets und Power-Ups. API-Tests für Endpunkte mit Jest und Supertest. Frontend-Unit-Tests mit Jasmine oder Jest. Optional E2E-Tests mit Cypress für den Happy Path. Ziel ist eine hohe Abdeckung der Kernlogik.
