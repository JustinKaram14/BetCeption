...
const BETCEPTION_STEPS: Record<LanguageCode, TutorialStep[]> = {
  de: [
    ...
    },
    {
      ...
      copy: 'Im Kartenmenü kannst du auf eine exakte Karte oder auf eine komplette Farbe setzen. Exakte Karten zahlen ca. 24:1, Farben ca. 2:1.',
      dealer: ['A', '?'],
      player: ['J', '♦'],
      action: 'hit',
      actionLabel: '24:1',
    ...
    },
    {
      ...
      copy: 'Dealer Bust gewinnt, wenn der Dealer nach deinem Zug Karten ziehen muss und dabei über 21 kommt. Die Auszahlung beträgt ca. 3,8:1.',
      dealer: ['10', '6', 'K'],
      player: ['9', '9'],
      action: 'dealer',
      actionLabel: '3:1',
    ...
    },
    {
      ...
      copy: 'Wenn eine rote oder blaue Pille im Slot liegt, kannst du darauf setzen, dass ihr Effekt in dieser Runde auslöst. Die rote Pille zahlt 10,5:1, die blaue Pille 14:1.',
      dealer: ['8', '?'],
      player: ['10', '7'],
      action: 'double',
      actionLabel: '14:1',
    ...
    },
    {
      ...
      copy: 'Die Blackjack-Wette trifft, wenn deine ersten zwei Karten direkt Blackjack ergeben. Die Auszahlung beträgt ca. 19:1.',
      dealer: ['9', '?'],
      player: ['A', 'K'],
      action: 'blackjack',
      actionLabel: '19:1',
    ...
    },
    {
      ...
      copy: 'Bei der Split-Wette sagst du vorher an, ob du genau 1x, 2x oder 3x splitten wirst. 1x zahlt ca. 6:1, 2x ca. 29:1 und 3x ca. 144:1.',
      dealer: ['7', '?'],
      player: ['8', '8'],
      action: 'split',
      actionLabel: '144:1',
  ...
  en: [
    ...
    },
    {
      ...
      copy: 'In the card menu you can bet on one exact card or an entire suit. Exact cards pay about 24:1, suits about 2:1.',
      dealer: ['A', '?'],
      player: ['J', '♦'],
      action: 'hit',
      actionLabel: '24:1',
    ...
    },
    {
      ...
      copy: 'Dealer Bust wins when the dealer has to draw after your turn and goes over 21. The payout is about 3.8:1.',
      dealer: ['10', '6', 'K'],
      player: ['9', '9'],
      action: 'dealer',
      actionLabel: '3:1',
    ...
    },
    {
      ...
      copy: 'If a red or blue pill is equipped, you can bet that its effect triggers this round. The red pill pays 10.5:1, and the blue pill pays 14:1.',
      dealer: ['8', '?'],
      player: ['10', '7'],
      action: 'double',
      actionLabel: '14:1',
    ...
    },
    {
      ...
      copy: 'The blackjack bet hits when your first two cards form a natural blackjack. The payout is about 19:1.',
      dealer: ['9', '?'],
      player: ['A', 'K'],
      action: 'blackjack',
      actionLabel: '19:1',
    ...
    },
    {
      ...
      copy: 'With the split-count bet you predict exactly 1x, 2x, or 3x splits. Payouts are about 1x 6:1, 2x 29:1, and 3x 144:1.',
      dealer: ['7', '?'],
      player: ['8', '8'],
      action: 'split',
      actionLabel: '144:1',
  ...
  es: [
    ...
    },
    {
      ...
      copy: 'En el menú de cartas puedes apostar por una carta exacta o por un palo completo. Las cartas exactas pagan aprox. 24:1 y los palos aprox. 2:1.',
      dealer: ['A', '?'],
      player: ['J', '♦'],
      action: 'hit',
      actionLabel: '24:1',
    ...
    },
    {
      ...
      copy: 'Dealer Bust gana si el dealer tiene que robar después de tu turno y supera 21. El pago es aprox. 3.8:1.',
      dealer: ['10', '6', 'K'],
      player: ['9', '9'],
      action: 'dealer',
      actionLabel: '3:1',
    ...
    },
    {
      ...
      copy: 'Si tienes equipada una píldora roja o azul, puedes apostar a que su efecto se active en esta ronda. La píldora roja paga 10.5:1 y la azul 14:1.',
      dealer: ['8', '?'],
      player: ['10', '7'],
      action: 'double',
      actionLabel: '14:1',
    ...
    },
    {
      ...
      copy: 'La apuesta de blackjack acierta si tus dos primeras cartas forman blackjack natural. El pago es aprox. 19:1.',
      dealer: ['9', '?'],
      player: ['A', 'K'],
      action: 'blackjack',
      actionLabel: '19:1',
    ...
    },
    {
      ...
      copy: 'Con la apuesta de split predices exactamente 1x, 2x o 3x splits. Paga aprox. 1x 6:1, 2x 29:1 y 3x 144:1.',
      dealer: ['7', '?'],
      player: ['8', '8'],
      action: 'split',
      actionLabel: '144:1',
  ...
  fr: [
    ...
    },
    {
      ...
      copy: 'Dans le menu cartes, tu peux parier sur une carte exacte ou une couleur complète. Les cartes exactes paient env. 24:1 et les couleurs env. 2:1.',
      dealer: ['A', '?'],
      player: ['J', '♦'],
      action: 'hit',
      actionLabel: '24:1',
    ...
    },
    {
      ...
      copy: 'Dealer Bust gagne si le dealer doit tirer après ton tour et dépasse 21. Le gain est env. 3,8:1.',
      dealer: ['10', '6', 'K'],
      player: ['9', '9'],
      action: 'dealer',
      actionLabel: '3:1',
    ...
    },
    {
      ...
      copy: 'Si une pilule rouge ou bleue est équipée, tu peux parier que son effet se déclenche cette manche. La pilule rouge paie 10,5:1 et la bleue 14:1.',
      dealer: ['8', '?'],
      player: ['10', '7'],
      action: 'double',
      actionLabel: '14:1',
    ...
    },
    {
      ...
      copy: 'Le pari blackjack touche si tes deux premières cartes forment un blackjack naturel. Le gain est env. 19:1.',
      dealer: ['9', '?'],
      player: ['A', 'K'],
      action: 'blackjack',
      actionLabel: '19:1',
    ...
    },
    {
      ...
      copy: 'Avec le pari split, tu prédis exactement 1x, 2x ou 3x splits. Les gains sont env. 1x 6:1, 2x 29:1 et 3x 144:1.',
      dealer: ['7', '?'],
      player: ['8', '8'],
      action: 'split',
      actionLabel: '144:1',
