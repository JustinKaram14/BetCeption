...
export const AppDataSource = new DataSource({
  ...
  migrations: [
    ...
    AddUserCrates1700000000003,
    AddCrateRewardToWalletKind1700000000004,
    AddStreakToUsersAndClaims1700000000005,
    AddXpBoostExpiry1700000000006,
    SeedPowerupTypes1700000000007,
    AddActivePowerPills1700000000008,
    AddBetceptionSidebets1700000000009,
    ReplaceWinnerWithDealerBustSidebet1700000000010,
    AddPlayerSplitHandType1700000000011,
    AddExpandedBetceptionSidebets1700000000012,
    AddUserProfileAvatar1700000000013,
