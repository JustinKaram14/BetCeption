...
const RawEnvSchema = z.object({
  ...
  RESEND_FROM: z.string().email().default('noreply@betception.de'),
...
const parseCookieSecure = (value: string | undefined, nodeEnv: string) => {
  if (value === undefined) {
...
const parseTrustProxy = (value: string | undefined): TrustProxyValue => {
...
export const env = {
  ...
  resend: rawEnv.RESEND_API_KEY
    ? { apiKey: rawEnv.RESEND_API_KEY, from: rawEnv.RESEND_FROM }
    : null,
